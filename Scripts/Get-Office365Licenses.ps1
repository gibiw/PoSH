...
{ 
 ...
 $headerstring = "DisplayName;UserPrincipalName;AccountSku;JobTitle;Office"
 ...
 foreach ($user in $users) {
        ...
        $datastring = (($user.displayname -replace ","," ") + ";" + $user.userprincipalname + ";" + $license.SkuPartNumber + ";" + $user.Title + ";" + $user.Office )
